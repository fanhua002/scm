...
public class Test20150607 {
	public static void main(String[] args)
	{
		Test20150607 test=new Test20150607();
		test.getabc();
...
//		System.out.println(subfolder);
	...
	/**
	    ...
	    从上述svn ls -v命令中获取第一行获取到184版本，将下面184版本对应的版本号3.15.2返回。
	 * @param b
	 * @param bnum
	 * @return
	 */
	...
	private void getabc()
	{
		for(int a=1;a<10;a++)
		{
			for(int b=1;b<10;b++)
			{
				for(int c=1;c<10;c++)
				{
					if((a*100+b*10+c)-(c*100+b*10+a)==(c*100+a*10+b))
					{
