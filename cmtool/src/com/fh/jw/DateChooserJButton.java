...
public class DateChooserJButton extends JButton {
	...
	static private DateChooserJButton dateChooserJButton_IL;
	...
	//
	// mainFrame.add(getDateChooserJButton_IL(), java.awt.BorderLayout.CENTER);
	//
	//
	//
	...
	// }
	//
	private static DateChooserJButton getDateChooserJButton_IL() {
		if (dateChooserJButton_IL == null) {
			dateChooserJButton_IL = new DateChooserJButton();
			dateChooserJButton_IL.setPreferredSize(new java.awt.Dimension(272,
					191));
		}
		return dateChooserJButton_IL;
	}
